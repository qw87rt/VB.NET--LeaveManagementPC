...
Public Class frmPending
    ...
    Private Async Sub frmPending_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim response As HttpResponseMessage = Await HttpClientSingleton.SharedClient.GetAsync("http://" & host & ":3000/adminside/pendingrequest", cts.Token)
    ...
    Private Sub PopulateDataGridView(requests As List(Of Request))
        Try
            ...
            dt.Columns.Add("Date Received", GetType(String))
            ...
            tblPending.DataSource = dt
            tblPending.Refresh()
            tblPending.ReadOnly = True
            tblPending.GridColor = Color.FloralWhite
            ...
            ApplyCommonDataGridViewSettings(tblPending)
    ...
    Protected Overrides Sub OnFormClosing(e As FormClosingEventArgs)
        If cts IsNot Nothing Then
            cts.Cancel()
            ' Optionally, you can wait for the task to complete if you want to ensure it has fully canceled before closing the form
    ...
    Private Sub btnView_Click(sender As Object, e As EventArgs) Handles btnView.Click
        Dim selectedRow = tblPending.CurrentRow
        If selectedRow IsNot Nothing AndAlso selectedRow.Cells("Control No.").Value IsNot Nothing Then
            Try
                ...
                frmViewInstance.MdiParent = _mainForm
    ...
    Private Sub docLeavereq_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles docLeavereq.PrintPage
        ...
        Dim selectedRow As DataGridViewRow = tblPending.CurrentRow
        ...
        If selectedRow IsNot Nothing Then
            ...
            Dim dateReceived As String = Convert.ToString(selectedRow.Cells("Date Received").Value)
            ...
            If dtProcessno > 1 Then
                ...
                'e.Graphics.DrawString("E- SIGNATURE HERE", header2, Brushes.Black, 520, 830)
            End If
    ...
    Private Async Sub btnFilterdept_Click(sender As Object, e As EventArgs) Handles btnFilterdept.Click
        ...
        isLoading = True
        If isLoading Then
            tblPending.Text = "Loading... Please wait..."
            btnFilterdept.Enabled = False
            TextBoxSearch.Enabled = False
            btnView.Enabled = False
            print.Enabled = False
        ...
        Else
            ...
            Dim reqStatus As String = "Pending" ' or get this value from somewhere else if it's dynamic
