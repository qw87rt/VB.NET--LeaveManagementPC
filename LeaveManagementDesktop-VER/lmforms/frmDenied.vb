...
Public Class frmDenied
    ...
    Private Async Sub frmDenied_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim response As HttpResponseMessage = Await HttpClientSingleton.SharedClient.GetAsync("http://" & host & ":3000/adminside/deniedrequest", cts.Token)
    ...
    Private Sub ApplyCommonDataGridViewSettings(dgv As DataGridView)
        ...
        Try
            ...
            'dgv.Columns("Date Denied").Visible = False
    ...
    Private Sub PopulateDataGridView(requests As List(Of Request))
        Try
            ...
            dt.Columns.Add("Date Denied", GetType(String))
            ...
            tblDenied.DataSource = dt
            tblDenied.Refresh()
            tblDenied.ReadOnly = True
            tblDenied.GridColor = Color.FloralWhite

            ApplyCommonDataGridViewSettings(tblDenied)
    ...
    Private Sub btnView_Click(sender As Object, e As EventArgs) Handles btnView.Click
        Dim selectedRow = tblDenied.CurrentRow
    ...
    Private Sub docLeavereq_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles docLeavereq.PrintPage
        ...
        Dim selectedRow As DataGridViewRow = tblDenied.CurrentRow
        ...
        If selectedRow IsNot Nothing Then
            ...
            Dim dateReceived As String = Convert.ToString(selectedRow.Cells("Date Denied").Value)
    ...
    Private Async Sub btnFilter_Click(sender As Object, e As EventArgs) Handles btnFilter.Click
        ...
        Else
            ...
            Dim reqStatus As String = "Denied" ' or get this value from somewhere else if it's dynamic
